...
LAYER_LOCK,    KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_MINS,               KC_LBRC, \
...
LAYER_LOCK,    KC_Q,              KC_W,              KC_E,              KC_R,              KC_T,                KC_Y,              KC_U,              KC_I,              KC_O,              KC_P,                  KC_LBRC, \
...
LAYER_LOCK, U_NA,      U_NA,     U_NA,     U_NA,     U_NA,         WIND_MAX_TOGGLE,   WIND_LEFT,  WIND_DOWN,  WIND_UP,    WIND_RIGHT,  LCTL(SE_MINS), \
...
LAYER_LOCK, RESET,    DF(U_TAP),  DF(U_EXTRA),  DF(U_BASE),   DT_PRNT,       RGB_TOG,   RGB_MOD,  RGB_HUI,  RGB_SAI,   RGB_VAI,  U_NP, \
...
LAYER_LOCK, SE_LABK,  SE_AMPR,  SE_LCBR,   SE_RCBR,   SE_AT,              SE_SLSH,   SE_TILD,   SE_CIRC,  U_NA,     SE_QUES,  U_NP, \
