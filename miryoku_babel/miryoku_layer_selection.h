...
#include "miryoku_layer_alternatives.h"
...
#if !defined(MIRYOKU_LAYER_PROJECT)
  #if defined (MIRYOKU_LAYERS_FLIP)
    #if defined (MIRYOKU_NAV_INVERTEDT)
      #define MIRYOKU_LAYER_PROJECT MIRYOKU_ALTERNATIVES_PROJECT_INVERTEDT_FLIP
    #else
      #define MIRYOKU_LAYER_PROJECT MIRYOKU_ALTERNATIVES_PROJECT_FLIP
    #endif
  #else
    #if defined (MIRYOKU_NAV_INVERTEDT)
      #define MIRYOKU_LAYER_PROJECT MIRYOKU_ALTERNATIVES_PROJECT_INVERTEDT
    #elif defined (MIRYOKU_NAV_VI)
      #define MIRYOKU_LAYER_PROJECT MIRYOKU_ALTERNATIVES_PROJECT_VI
    #else
      #define MIRYOKU_LAYER_PROJECT MIRYOKU_ALTERNATIVES_PROJECT
    #endif
  #endif
#endif
#if !defined(MIRYOKU_LAYERMAPPING_PROJECT)
  #define MIRYOKU_LAYERMAPPING_PROJECT MIRYOKU_MAPPING
#endif
  ...
  #else
    #define MIRYOKU_LAYER_SYM MIRYOKU_ALTERNATIVES_SYM_TWO
  #endif
#endif
