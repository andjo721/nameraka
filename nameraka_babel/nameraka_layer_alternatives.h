...
// SPLIT 3x6
// Only 3x5 is used, the outer columns are not really used/needed, and mostly not defined.
...
// -e NAMERAKA_ALPHAS=QWERTY -e NAMERAKA_EXTRA=COLEMAKDH -e NAMERAKA_TAP=QWERTY
...
#define NAMERAKA_ALTERNATIVES_TAP_COLEMAKDH                              \
...
// Emacs/Emacs Project
#define NAMERAKA_ALTERNATIVES_PROJECT \
U_NP,    LSP_FORMAT_REGION, VC_LOG,      VC_ANNOTATE, VC_REVERT_HUNK, U_NA,                 LSP_TYPE_DEFINITION,   LSP_REFERENCES,      CCLS_CALL_HIERARCHY,   CCLS_MEMBER_HIERARCHY, PRJ_PROJS,   U_NP, \
U_NP,       PRJ_OTHER_FILE, PRJ_SEARCH,  VC_DIFF,  PRJ_FILES,       MAGIT_STATUS,         HELM_RESUME,           GO_TO,               GO_BACK,               LSP_LENS, U_NP,        U_NP, \
U_NP,       U_NA,           U_NA,   S(KC_F12),     DIRED_JUMP,      PERSP_BUF,            LSP_RENAME,            FLYCHECK_NEXT_ERROR, FLYCHECK_PREV_ERROR,   U_NP,     U_NP,        U_NP, \
...
U_NP,       KC_F10, KC_F1, KC_F2, KC_F3, KC_PAUS,        U_NA,        KC_MEH,      U_NA,         U_NA,       U_NA,     U_NP, \
                           KC_APP,KC_SPC, LGUI(KC_GRV),  U_NA,        U_NA,        U_NA
...
#define NAMERAKA_ALTERNATIVES_BUTTON \
U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        \
U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        \
U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        U_NP,        \
