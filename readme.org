...
* andjo corne
I started with miryoku as a base, and built my own users config on top of it.

1. Install qmk
2. Install miryoku
3. git clone andjo_corne
4. ln -sf $(pwd)/users/andjo_corne $(pwd)/users/manna-harbour_miryoku
